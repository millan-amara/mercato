  ...
  return (
    <div className='h-[100dvh] md:h-auto flex flex-col md:flex-row justify-center items-center'>
      ...
      <form onSubmit={handleSubmit} className='md:w-4/5 lg:w-3/5'>
        ...
        <button type="submit" className='w-full rounded-md text-lg px-3 py-3 mb-2 font-semibold bg-gradient-to-l from-fuchsia-800 via-slate-800 to-gray-950 hover:bg-gradient-to-r text-white'>Sign Up</button>
      </form>
      </div> 
