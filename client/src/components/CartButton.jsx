...
function CartButton({ cartItems }) {
  ...
  return (
    <Link
        ...
        className="fixed bottom-20 right-5 z-50 bg-black text-white rounded-full p-4 shadow-lg hover:bg-slate-800 transition-all duration-300 flex items-center justify-center"
    >
